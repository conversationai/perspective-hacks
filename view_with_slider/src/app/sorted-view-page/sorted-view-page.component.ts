...
@Component({
  selector: 'app-sorted-view-page',
  templateUrl: './sorted-view-page.component.html',
  styleUrls: ['./sorted-view-page.component.css'],
  animations: [
...
export class SortedViewPageComponent implements OnInit {
